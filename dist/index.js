  ...
  module.exports = function(app) {
    app.service('mailService', [function() {
      ...
      this.getMail = function() {
        return [new Mail(1, "john@doe.com", "dexter@miguel.com", "this is a test", "this is a test"), new Mail(2, "mary@doe.com", "daniel@miguel.com", "this is another test", "this is a test")];
      };
    }]);
  };
  global.define = __define;
...
$__System.registerDynamic("7", ["8"], true, function($__require, exports, module) {
  ...
  var global = this,
      __define = global.define;
  global.define = undefined;
  var jade = $__require('8');
  module.exports = function template(locals) {
    var buf = [];
    var jade_mixins = {};
    var jade_interp;
    buf.push("<div ng-click=\"view(message)\" class=\"row selectable\"><div class=\"four columns\">{{message.senders}}</div><div class=\"eight columns\">{{message.body}}</div></div>");
    ;
    return buf.join("");
  };
  global.define = __define;
...
$__System.registerDynamic("9", ["7"], true, function($__require, exports, module) {
  ...
  global.define = undefined;
  module.exports = function(app) {
    app.directive('mailRow', ['$state', function($state) {
      return {
        restrict: 'E',
        scope: {message: '=message'},
        template: $__require('7'),
...
$__System.registerDynamic("a", [], true, function($__require, exports, module) {
  ...
  global.define = undefined;
  module.exports = function(app) {
    app.controller('InboxController', ['mailService', '$scope', function(mailService, $scope) {
...
$__System.registerDynamic("b", [], true, function($__require, exports, module) {
  ...
  global.define = undefined;
  module.exports = function(app) {
    app.controller('MessageController', ['mailService', '$stateParams', '$scope', '$state', function(mailService, $stateParams, $scope, $state) {
...
$__System.registerDynamic("c", ["8"], true, function($__require, exports, module) {
  ...
  module.exports = function template(locals) {
    ...
    var jade_mixins = {};
    var jade_interp;
    buf.push("<div class=\"row section\"><div class=\"three columns\"><a href=\"#/\">Inbox</a><a href=\"#/\">Sent Items</a></div><div class=\"seven columns\"><mail-row message=\"message\" ng-repeat=\"message in messages\"></mail-row></div></div>");
    ;
    return buf.join("");
  };
  global.define = __define;
...
$__System.registerDynamic("8", ["@empty"], true, function($__require, exports, module) {
  "use strict";
  ;
  var global = this,
      __define = global.define;
...
$__System.registerDynamic("d", ["8"], true, function($__require, exports, module) {
  ...
  module.exports = function template(locals) {
    ...
    var jade_mixins = {};
    var jade_interp;
    buf.push("<div><button ng-click=\"back()\">Back</button></div><div><div>{{message.body}}</div></div>");
    ;
    return buf.join("");
  };
  global.define = __define;
...
$__System.registerDynamic("1", ["3", "5", "6", "9", "a", "b", "c", "d"], true, function($__require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  var angular = $__require('3');
  var uirouter = $__require('5');
  var app = angular.module('app', ['ui.router']);
  var mailService = $__require('6')(app);
  var mailRowDirective = $__require('9')(app);
  var inboxController = $__require('a')(app);
  var messageController = $__require('b')(app);
  app.config(['$stateProvider', function(stateProvider) {
    stateProvider.state('inbox', {
      url: '/',
      template: $__require('c'),
      controller: 'InboxController'
    }).state('message', {
      url: '/message/:id',
      template: $__require('d'),
